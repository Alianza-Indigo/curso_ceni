...
const modulo2: Modulo = {
  ...
  quiz: [
    ...
    {
      id: "m2q11",
      pregunta: "¿Cuál es el axioma fundamental del que parte la comunicación neuroafirmativa?",
      opciones: [
        "Existe una forma correcta de comunicarse que todos deben aprender",
        "No existe una forma correcta de comunicarse; las diferencias no son déficits sino variaciones que el entorno debe acomodar",
        "La comunicación verbal oral es superior a otras formas de comunicación",
        "Las personas neurodivergentes deben adaptarse al estilo comunicativo predominante",
      ],
      correcta: 1,
      explicacion: "El axioma fundamental establece que no existe una forma correcta de comunicarse y que las diferencias son variaciones que el entorno debe acomodar activamente, no déficits.",
    },
    {
      id: "m2q12",
      pregunta: "Según el principio de predictibilidad, ¿qué efecto tienen los cambios de último momento en la agenda?",
      opciones: [
        "Ninguno, la mayoría de las personas se adapta sin problema",
        "Generan estrés desproporcionado y por eso deben anticiparse con suficiente antelación",
        "Solo afectan a quienes tienen mala organización personal",
        "Mejoran la capacidad de reacción de los equipos",
      ],
      correcta: 1,
      explicacion: "El principio de predictibilidad indica que hay que anticipar cambios, agenda y expectativas con antelación porque los cambios de último momento generan estrés desproporcionado.",
    },
    {
      id: "m2q13",
      pregunta: "Según el principio de validación de la experiencia, las expresiones emocionales atípicas:",
      opciones: [
        "Deben corregirse mediante retroalimentación conductual",
        "Son válidas y no requieren \"corrección\"",
        "Solo se aceptan en contextos privados",
        "Deben reportarse al área de recursos humanos",
      ],
      correcta: 1,
      explicacion: "El principio de validación de la experiencia establece que las expresiones emocionales atípicas son válidas y no requieren \"corrección\".",
    },
    {
      id: "m2q14",
      pregunta: "¿Cuál de las siguientes es un ejemplo de SAAC de alta tecnología según el módulo?",
      opciones: [
        "Cuadernos de comunicación",
        "Tarjetas PECS",
        "Aplicación Proloquo2Go",
        "Señas convencionales",
      ],
      correcta: 2,
      explicacion: "Proloquo2Go, junto con Grid y LetMeTalk, se menciona como ejemplo de SAAC de alta tecnología, al igual que los sintetizadores de voz y la predicción de texto.",
    },
    {
      id: "m2q15",
      pregunta: "Dentro de la comunicación escrita como SAAC, ¿qué canal se señala como preferente sobre las llamadas o reuniones verbales?",
      opciones: [
        "El correo electrónico",
        "Las notas de voz",
        "Las videollamadas",
        "Los memorandos impresos",
      ],
      correcta: 0,
      explicacion: "El módulo señala el correo como canal preferente sobre las llamadas o reuniones verbales dentro de la comunicación escrita.",
    },
    {
      id: "m2q16",
      pregunta: "Las tarjetas rojo/verde/amarillo y los pictogramas ARASAAC son ejemplos de:",
      opciones: [
        "SAAC de alta tecnología",
        "Comunicación simbólica",
        "Coerción social comunicativa",
        "Protocolo de adaptación en entrevistas",
      ],
      correcta: 1,
      explicacion: "Los pictogramas ARASAAC, códigos de colores, señalización visual y tarjetas rojo/verde/amarillo son ejemplos de comunicación simbólica.",
    },
    {
      id: "m2q17",
      pregunta: "¿Qué exige el criterio CENI Espacios D3-C3?",
      opciones: [
        "Protocolos escritos de comunicación accesible para colaboradores",
        "Tableros de comunicación o SAAC en el punto de atención al público",
        "Un evaluador capacitado en comunicación neuroafirmativa",
        "Antelación mínima de 48 horas para evaluaciones",
      ],
      correcta: 1,
      explicacion: "CENI Espacios D3-C3 exige tableros de comunicación o SAAC en el punto de atención al público, mientras que CENI Laboral D3-C3 exige protocolos escritos de comunicación accesible.",
    },
    {
      id: "m2q18",
      pregunta: "¿Qué evidencia se requiere para acreditar los criterios CENI de comunicación accesible (D3-C3)?",
      opciones: [
        "Solo una declaración firmada por la gerencia",
        "Fotografía del material más el protocolo escrito de uso",
        "Un certificado emitido por un tercero externo",
        "El registro de asistencia a una capacitación",
      ],
      correcta: 1,
      explicacion: "La evidencia requerida es la fotografía del material más el protocolo escrito de uso.",
    },
    {
      id: "m2q19",
      pregunta: "¿Cómo define el módulo la \"coerción social comunicativa\"?",
      opciones: [
        "Cualquier corrección ortográfica en documentos internos",
        "Cualquier práctica que condiciona la participación, evaluación o valoración de una persona a la demostración de comportamientos comunicativos neurotípicos",
        "El uso de SAAC de baja tecnología en vez de alta tecnología",
        "La exigencia de usar lenguaje literal en reuniones",
      ],
      correcta: 1,
      explicacion: "Se define como cualquier práctica que condiciona la participación, evaluación o valoración de una persona a la demostración de comportamientos comunicativos neurotípicos, una forma de discriminación sistemática frecuentemente invisible.",
    },
    {
      id: "m2q20",
      pregunta: "¿Cuál de las siguientes prácticas debe eliminarse según el módulo?",
      opciones: [
        "Ofrecer alternativas escritas a la disponibilidad telefónica inmediata",
        "Requerir disponibilidad telefónica inmediata sin alternativas escritas",
        "Anticipar cambios de agenda con antelación",
        "Solicitar permiso antes de iniciar contacto visual",
      ],
      correcta: 1,
      explicacion: "Entre las prácticas que deben eliminarse está requerir disponibilidad telefónica inmediata sin ofrecer alternativas escritas.",
    },
  ],
};
